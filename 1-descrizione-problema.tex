...
\begin{itemize}
	...
	\item Jolly: come cassa-reparto, solo che può essere assegnato ad altri reparti; può essere specifico per particolari reparti o può ricoprire qualsiasi ruolo all'interno dell'ipermercato.
\end{itemize}
