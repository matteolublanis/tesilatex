...
\end{center}
La finestra temporale che andiamo a modellizzare è di una settimana. L'ipermercato è stato abbastanza gentile da fornirci un fabbisogno settimanale medio, il quale riesce a rappresentare adeguatamente le reali necessità che si possono avere durante il corso dell'anno, salvo eventuali periodi particolari durante i quali il flusso della clientela aumenta notevolmente (come dicembre). Definiamo quindi:
\begin{center}
