...
\end{align}
che indica quanto vale la sovracopertura misurata. $\Delta(d,k)$ non può essere minore di 0, in quanto una situazione di difetto di personale non è ammessa (cambiando i vincoli, si potrebbe introdurre anche questa situazione). Si vuole ora minimizzare la situazione di sovracopertura:
\begin{equation}
	f_9=\sum_{d\in D}\sum_{k\in T(d)}\Delta(d,k)
\end{equation}
